...
class SistemaGestao:
    def __init__(self, master=None):
        ...
        self.btn_visualizar_pdf = Button(self.janela_botoes, text="Visualizar PDF", font=self.fontePadrao, width=15,
                                         command=self.visualizarPdf)
    ...
    def visualizarPdf(self):
        ...
        # Cria um nome de arquivo temporário para o PDF
        ...
        # Tenta abrir o PDF usando o visualizador padrão do sistema
        try:
